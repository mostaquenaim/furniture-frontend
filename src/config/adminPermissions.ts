...
export const EXTRA_ROUTE_PERMISSIONS: NavSubItem[] = [
  ...
  { href: "/admin/category/update", label: "Edit Category (stub)", requiredAction: "CATEGORY_UPDATE" },
  ...
  { href: "/admin/series", label: "Series (stub)", requiredAction: "CATEGORY_VIEW" },
  { href: "/admin/series/arrange", label: "Arrange Series", requiredAction: "CATEGORY_REORDER" },
