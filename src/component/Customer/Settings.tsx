...
const Settings = () => {
  ...
  const [notifications, setNotifications] = useState<NotificationSetting[]>([
    { id: 'email', label: 'Email Notifications', description: 'Receive order updates via email', enabled: true },
    { id: 'promo', label: 'Promotional Emails', description: 'Receive special offers and promotions', enabled: false },
    { id: 'order', label: 'Order Updates', description: 'Real-time order status notifications', enabled: true },
    { id: 'security', label: 'Security Alerts', description: 'Important account security notifications', enabled: true },
    { id: 'newsletter', label: 'Weekly Newsletter', description: 'Curated furniture and design tips', enabled: false },
  ]);

  // Privacy settings
  const [privacy, setPrivacy] = useState<PrivacySetting[]>([
    { id: 'profile', label: 'Public Profile', description: 'Allow others to view your profile', value: false },
    { id: 'activity', label: 'Activity Visibility', description: 'Show your recent activity', value: true },
    { id: 'personalized', label: 'Personalized Ads', description: 'Show personalized recommendations', value: true },
    { id: 'data', label: 'Data Sharing', description: 'Share anonymous usage data', value: false },
  ]);
  ...
  const sections: SettingsSection[] = [
    { id: 'profile', title: 'Profile Information', description: 'Update your personal details', icon: <User className="w-5 h-5" /> },
    { id: 'notifications', title: 'Notifications', description: 'Manage your notification preferences', icon: <Bell className="w-5 h-5" /> },
    { id: 'privacy', title: 'Privacy & Security', description: 'Control your privacy settings', icon: <Shield className="w-5 h-5" /> },
    { id: 'preferences', title: 'Preferences', description: 'Customize your experience', icon: <Globe className="w-5 h-5" /> },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-sm p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-900 mb-1">Notification Frequency</h3>
            <p className="text-xs text-gray-500">
              You can adjust how often you receive notifications in your device settings.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Get notified of new sign-ins</p>
                </div>
              </div>
            </div>
            <button
  ...
  const PreferencesSection = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-200 rounded-sm p-6">
        <h3 className="text-base font-medium text-gray-900 mb-4">Display Preferences</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between py-3 border-b border-gray-100">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Dark Mode</p>
              <p className="text-xs text-gray-500 mt-1">Use dark theme across the application</p>
            </div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100">
            ...
            <button className={`relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 transition`}>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-medium text-gray-900 mb-2">Account Settings</h1>
        <p className="text-sm text-gray-500">Manage your account preferences and privacy settings</p>
      </div>
        ...
        <div className="lg:w-64 flex-shrink-0">
          <div className="bg-white border border-gray-200 rounded-sm overflow-hidden">
            {sections.map((section) => (
              ...
              >
                <div className={`${activeSection === section.id ? 'text-gray-900' : 'text-gray-500'}`}>
                  {section.icon}
                </div>
                <div>
